...
class StopTimeUpdate extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $stop_id
     *     @type \TransitRealtime\TripUpdate\StopTimeEvent $arrival
     *     @type \TransitRealtime\TripUpdate\StopTimeEvent $departure
    ...
    /**
     * Generated from protobuf field <code>.transit_realtime.TripUpdate.StopTimeEvent arrival = 2;</code>
     * @return \TransitRealtime\TripUpdate\StopTimeEvent|null
     */
    ...
    /**
     * Generated from protobuf field <code>.transit_realtime.TripUpdate.StopTimeEvent arrival = 2;</code>
     * @param \TransitRealtime\TripUpdate\StopTimeEvent $var
     * @return $this
     */
    public function setArrival($var)
    {
        GPBUtil::checkMessage($var, \TransitRealtime\TripUpdate\StopTimeEvent::class);
        $this->arrival = $var;
    ...
    {
        GPBUtil::checkEnum($var, \TransitRealtime\TripUpdate\StopTimeUpdate\ScheduleRelationship::class);
